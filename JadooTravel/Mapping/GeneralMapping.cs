...
namespace JadooTravel.Mapping
{
    public class GeneralMapping : Profile
    {
        public GeneralMapping()
        {
            ...
            CreateMap<Destination, ResultLast5DestinationDto>().ReverseMap();
            ...
            CreateMap<CreateFeatureDto, UpdateFeatureDto>().ReverseMap();
            ...
            CreateMap<CreateTripPlanDto, UpdateTripPlanDto>().ReverseMap();
        }
    }
}